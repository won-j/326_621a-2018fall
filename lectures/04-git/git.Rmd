...
author: "Joong-Ho Won @ SNU (heavily indebted to Hua Zhou @ UCLA)"
...
<p align="center">
  <img src="./phd101212s.gif" height="375">
</p>
...
- [GitHub](github.com) is becoming a de facto central repository for open source development. E.g., all packages in Julia are distributed through GitHub; Hadley Wickham also [recommends](http://r-pkgs.had.co.nz/git.html) Git/GitHub as the best practices for R package development.
...
- [Happy Git with R](http://happygitwithr.com/) by [Jenny Bryan](https://www.stat.ubc.ca/~jenny/).
...
- [Git-the simple guide](https://rogerdudler.github.io/git-guide/index.html) by Roger Dudler. [Korean version](https://rogerdudler.github.io/git-guide/index.ko.html)
...
- Initialize a project.
    ...
    - Create a repository, e.g., `snustat-326-621a-fall` on the server.
...
- Be judicious what to put in repository.
    ...
    - Strictly version control system is for source files only, e.g. `xxx.Rmd`, `xxx.bib`, and figure files are necessary to produce a pdf file. Pdf file doesn't need to be version controlled or, if version controlled, doesn't need to be frequently committed.
    
- Commit early, commit often and don't spare the horses.
    
- Adding an informative message when you commit is __not__ optional. Spending one minute on commit message saves hours later for your collaborators and "future-you". Read the following mantra to yourself 3 times:
